(defproject real-world-clojure "0.1.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.11.1"]
                 ...
                 [ring/ring-defaults "0.4.0" :exclusions [ring/ring-core]]
                 [buddy/buddy-core "1.11.423"]
                 [buddy/buddy-hashers "2.0.167"]
                 [buddy/buddy-sign "3.5.351"]
                 [buddy/buddy-sign "3.5.351" :exclusions [cheshire]]
                 [buddy/buddy-hashers "2.0.167" :exclusions [cheshire]]
                 [buddy/buddy-core "1.11.423" :exclusions [cheshire]]
                 [c3p0/c3p0 "0.9.1.2"]
                 [org.clojure/java.jdbc "0.2.3"]
                 [com.h2database/h2 "1.3.168"]
                 [migratus "1.5.3"]
                 [org.postgresql/postgresql "42.3.3"]
                 [com.github.seancorfield/next.jdbc "1.3.894" :exclusions [org.clojure/tools.logging]]
